...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -5,-2), S(  9,  3), S( 10,12), S(17, 7) },
   { S(-14, 0), S( -2,  3), S( 23, 6), S(24, 4) },
   { S(-14, 6), S( -2,  0), S( 16,-7), S(25,-4) },
   { S( -5,20), S( -6,  5), S( -2,-7), S( 4,-2) },
   { S(-10,12), S( -6, 10), S(  2, 4), S( 9,14) },
   { S(  3,-1), S( 23,-15), S( -2,12), S(10,18) }
  },
  { // Knight
