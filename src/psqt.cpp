...
Value PawnValueMg   = (Value)142;
Value PawnValueEg   = (Value)207;
Value KnightValueMg = (Value)784;
Value KnightValueEg = (Value)868;
Value BishopValueMg = (Value)828;   
Value BishopValueEg = (Value)916;
Value RookValueMg   = (Value)1286;  
