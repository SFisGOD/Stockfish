...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -9,-4), S(  5,  0), S( 6, 8), S(15, 1) },
   { S(-16,-2), S( -4,  3), S(23, 4), S(23, 0) },
   { S(-11, 9), S( -6, -5), S(20,-9), S(25, 1) },
   { S( -4,14), S( -2,  9), S(-1, 0), S(11,-5) },
   { S(-12,17), S(-13,  6), S(-1, 2), S( 6,18) },
   { S( -3,-1), S( 22,-13), S(-7, 5), S( 0,26) }
  },
  { // Knight
