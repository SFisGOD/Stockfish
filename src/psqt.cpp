...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-43,-52), S(  0,-27), S( -9,-23), S(-30,-18) },
   { S(-14,-38), S( 12,-18), S( 20,-10), S(  3,  4) },
   { S(-10,-16), S( 28, -8), S( -3,  1), S( 15, 13) },
   { S( -3,-34), S(  3, -3), S( 24, -1), S( 40, 14) },
   { S(-13,-34), S( 26,  0), S( 19, -5), S( 37, 21) },
   { S(-10,-20), S( 15,-10), S(-12,-14), S( 16, 19) },
   { S(-19,-38), S(-17,-10), S(  3,-15), S( -6,  4) },
   { S(-50,-50), S( -8,-24), S(-25,-31), S(-25,-24) }
  },
  { // Rook
