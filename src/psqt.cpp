...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   ...
   { S( -7,-25), S( 29, -5), S( 18, -9), S( 29, 16) },
   { S(-17,-25), S(  9, -2), S( -3,  1), S(  7, 15) },
   { S(-20,-34), S(-16,-14), S(  9, -9), S( -8,  8) },
  ...
  { // Rook
   ...
   { S(-17,-3), S( -6, 3), S( -4,-5), S(-5, 6) },
   { S(-23,-8), S(-12, 5), S( -1, 0), S( 5,-8) },
   { S(-24, 3), S( -7, 0), S(  3,-6), S( 8, 5) },
   { S( -9, 0), S(  7, 4), S( 10,14), S(12,-5) },
