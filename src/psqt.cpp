...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-63,-51), S( -5,-31), S( -6,-39), S(-17,-16) },
   { S(-11,-35), S(  9,-12), S( 23,-19), S(  4,  2) },
   { S( -5,-15), S( 18, -3), S( -7,  3), S( 18,  8) },
   { S(-10,-14), S( 14, -9), S( 24,  0), S( 41, 18) },
   { S(-17,-11), S( 27,  4), S( 20,-17), S( 34, 13) },
   { S(-16,-33), S(  7,  9), S(  4,  6), S( 15, -3) },
   { S(-14,-29), S( -9,-22), S(  0,  6), S(  5, -6) },
   { S(-49,-41), S(  4,-45), S(-17,-35), S(-22,-29) }
  },
  { // Rook
