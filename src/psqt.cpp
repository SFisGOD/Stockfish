...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-54,-58), S( -7,-31), S( -6,-37), S(-24,-17) },
   { S(-20,-38), S(  7,-14), S(  7,-14), S( -4,  4) },
   { S( -9,-23), S( 22, -2), S(  0, -3), S( 12, 11) },
   { S(  3,-30), S(  5, -6), S( 27, -5), S( 42, 20) },
   { S(-15,-19), S( 24,  0), S( 13, -7), S( 30, 14) },
   { S(-17,-24), S( 17, -2), S(-13, -3), S(  8, 13) },
   { S(-19,-41), S( -7,-10), S(  7,-12), S(-11,  6) },
   { S(-49,-52), S(-16,-30), S(-12,-36), S(-23,-14) }
  },
  { // Rook
