...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-54,-55), S(-14,-33), S( -6,-34), S(-24,-17) },
   { S(-20,-37), S(  7,-14), S( 11,-18), S( -4,  8) },
   { S( -2,-20), S( 30, -2), S( -2,  0), S( 10, 14) },
   { S(  3,-27), S(  7, -5), S( 21, -2), S( 41, 20) },
   { S(-15,-19), S( 26, -2), S( 16, -3), S( 30, 12) },
   { S(-20,-36), S( 17,  2), S(-13, -2), S(  8, 18) },
   { S(-13,-41), S( -9,-12), S(  8,-14), S(-16,  6) },
   { S(-49,-52), S( -9,-30), S(-12,-38), S(-27,-14) }
  },
  { // Rook
