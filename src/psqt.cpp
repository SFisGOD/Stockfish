...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-167,-105), S(-96,-76), S(-80,-46), S(-78,-17) },
   { S( -80, -70), S(-40,-56), S(-23,-15), S( -9,  7) },
   { S( -66, -41), S(-20,-35), S(  3, -5), S( 17, 27) },
   { S( -28, -37), S(  8,-15), S( 42, 13), S( 47, 35) },
   { S( -28, -42), S( 14,-21), S( 41,  4), S( 52, 36) },
   { S( -12, -52), S( 30,-38), S( 61,-15), S( 58, 21) },
   { S( -66, -64), S(-21,-46), S(  6,-34), S( 31, 15) },
   { S(-199,-101), S(-77,-89), S(-50,-53), S(-32,-15) }
  },
  { // Bishop
