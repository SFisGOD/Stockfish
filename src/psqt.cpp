...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-51,-57), S( -9,-32), S( -9,-36), S(-31,-18) },
   { S(-23,-35), S(  8,-11), S( 14,-15), S( -1,  5) },
   { S( -7,-22), S( 25, -1), S( -3, -2), S( 11, 15) },
   { S(  4,-26), S(  8, -4), S( 19, -4), S( 40, 17) },
   { S(-10,-24), S( 27, -3), S( 14, -6), S( 30, 13) },
   { S(-18,-28), S( 15, -1), S( -8, -1), S(  7, 15) },
   { S(-17,-36), S(-12,-11), S(  7,-13), S(-13,  6) },
   { S(-48,-54), S( -8,-31), S(-15,-37), S(-28,-16) }
  },
  { // Rook
