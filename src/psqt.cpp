...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -6,-6), S(  2,  3), S( 5,  9), S(12, 0) },
   { S(-17,-3), S( -5,  4), S(22,  0), S(23, 2) },
   { S( -5,13), S( -4, -6), S(20,-12), S(28,-2) },
   { S( -2,15), S( -2,  7), S(-1,  3), S( 8, 2) },
   { S(-14,20), S(-14,  6), S( 0,  3), S(11,23) },
   { S( -4,-5), S( 26,-14), S(-2,  4), S( 3,29) }
  },
  { // Knight
