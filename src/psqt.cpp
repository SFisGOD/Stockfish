...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-23, 0), S(-14, 0), S( -8, 2), S( 0, 2) },
   { S(-18,-6), S( -7,-4), S( -1,-7), S( 2,-2) },
   { S(-19, 5), S( -8,-5), S(  2, 2), S( 1, 3) },
   { S(-19,-2), S( -8, 2), S( -4,-3), S(-5, 1) },
   { S(-20,-4), S(-11, 4), S(  0,-7), S( 4,-4) },
   { S(-24, 0), S(-10, 3), S( -1,-1), S( 5, 2) },
   { S(-13,-2), S(  7, 7), S(  7, 7), S(13, 0) },
   { S(-25, 7), S(-18, 5), S(-14, 6), S( 1, 0) }
  },
  { // Queen
