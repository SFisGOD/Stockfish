...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  0,-10), S( -6, -2), S(  8, 15), S(  7,  2), S( 26, -3), S( 20,  5), S(  7, -1), S( -2,-27) },
   { S( -7, -5), S( -9, -6), S( 11,  1), S( 23, -1), S( 26,  9), S( 28,  1), S(  7, -4), S(-21, -9) },
   { S( -7,  5), S(-18,-15), S(  6,  1), S( 23,-10), S( 34, -6), S( 30,-14), S( -4, -6), S(-18,-12) },
   { S(  7, 22), S(-11, -2), S(-12,  1), S( -1,-13), S( 15,-11), S( 14,-15), S( -6, 12), S(  7,  6) },
   { S( -7, 25), S(  3, 14), S(  3, 22), S( 14, 41), S(-20, 38), S(  1, 12), S(-13, 12), S(-13, 10) },
   { S(-10, -7), S(  4, -6), S( -4, 20), S(-10, 22), S(  3, 24), S(-20, 23), S(  9, 10), S(  6, 14) }
  };
