...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(274, -2), S(331, 37), S(274, 80), S(192, 88) },
   { S(274, 58), S(307, 98), S(249,138), S(186,129) },
   { S(204, 82), S(251,138), S(176,168), S(124,171) },
   { S(174,101), S(190,151), S(134,170), S(106,173) },
   { S(148, 95), S(171,170), S(114,200), S( 59,192) },
   { S(120, 88), S(159,158), S( 81,175), S( 31,189) },
   { S( 93, 39), S(121, 90), S( 65,125), S( 25,140) },
   { S( 63,  7), S( 89, 60), S( 57, 80), S( -2, 73) }
  }
};
