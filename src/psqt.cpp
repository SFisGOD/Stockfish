...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-49,-58), S(- 7,-30), S(-10,-38), S(-32,-18) },
   { S(-23,-35), S(  8, -9), S( 12,-12), S(  0,  1) },
   { S(-10,-24), S( 22, -1), S( -4, -2), S( 13, 14) },
   { S(  4,-27), S(  8, -4), S( 21, -3), S( 41, 17) },
   { S( -9,-26), S( 26, -3), S( 12, -8), S( 32, 17) },
   { S(-17,-23), S( 15, -2), S( -7, -1), S(  7, 13) },
   { S(-20,-34), S(-11,-10), S(  6,-12), S(-11,  7) },
   { S(-47,-54), S(-10,-32), S(-16,-36), S(-27,-16) }
  },
  { // Rook
