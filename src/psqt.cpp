...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-29, -8), S(-19,-14), S(-11,-10), S(-3, -9) },
   { S(-21,-17), S(-18, -8), S( -7,  0), S( 6, -1) },
   { S(-27,  3), S(-16, -6), S(  3,  3), S( 8,-13) },
   { S(-14, -4), S( -3, -1), S( -8, -9), S(-7,  9) },
   { S(-32, -2), S(-10, 10), S( -2, 10), S( 6, -1) },
   { S(-19,  7), S( -2,  8), S(  5, -8), S( 6, 13) },
   { S( -1,  3), S( 11,  4), S( 14, 21), S(20, -5) },
   { S(-10, 20), S(-20, -1), S(  1, 23), S( 4, 16) }
  },
  { // Queen
