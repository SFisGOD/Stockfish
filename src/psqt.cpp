...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  3,-10), S( -2, -8), S( 10, 10), S( 19, -5), S( 16, 14), S( 19,  7), S( 12,  2), S( -5,-19) },
   { S( -4,-10), S(-20,-10), S( 11,-13), S( 15,  4), S( 27,  4), S( 24,  3), S(  5, -6), S(-22, -4) },
   { S( -5,  6), S(-12,  1), S(  6, -8), S( 20, -4), S( 38,-13), S( 22,-12), S(  4, -6), S(-12, -9) },
   { S( 18,  9), S(  0,  4), S(-13,  3), S( -1,-12), S( 11,-12), S(  3, -8), S(-13, 10), S(  5,  8) },
   { S( -5, 28), S(-18, 16), S( -7, 21), S( 18, 28), S( -5, 30), S(  0, 11), S(-20,  6), S(-18, 13) },
   { S( -8,  5), S(  5, -7), S( -3, 12), S(-13, 21), S(  5, 25), S(-10, 19), S( 10,  4), S( -8,  7) }
  };
