...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -4,-13), S(  4, 2), S(13,  2), S(18,  5) },
   { S(-22, -2), S( -6,-1), S(25, -2), S(27, -3) },
   { S(-13,  1), S(-11, 4), S(17,-11), S(25, -2) },
   { S( -2, 13), S( -6, 8), S(-6,  1), S( 6,-11) },
   { S(-10, 21), S(-13,10), S( 2,  8), S( 1, 16) },
   { S(-10,  2), S( 12,-8), S(-7, 12), S(-8, 19) }
  },
  { // Knight
