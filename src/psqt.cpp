...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-51,-58), S( -5,-30), S( -9,-36), S(-24,-11) },
   { S(-15,-37), S(  8,-13), S( 18,-16), S(  3,  1) },
   { S( -7,-17), S( 22, -1), S( -4, -3), S( 16, 11) },
   { S( -3,-21), S( 10, -5), S( 25,  1), S( 38, 17) },
   { S(-11,-19), S( 29, -2), S( 22,-13), S( 31, 16) },
   { S(-16,-29), S(  5,  5), S(  1,  3), S( 11,  8) },
   { S(-18,-32), S(-15,-19), S(  6, -2), S( -2,  3) },
   { S(-48,-47), S(  0,-42), S(-14,-38), S(-24,-24) }
  },
  { // Rook
