...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  1,  3), S(  1, -1), S( 11,  0), S( 14, 10), S( 18, 14), S( 24,  8), S( 10,  0), S( -2,-21) },
   { S( -2,-10), S(-19, -4), S( 18, -7), S( 10, -6), S( 35, -5), S( 28,  2), S(  4, -6), S(-20, -4) },
   { S( -2,  1), S(-25, -3), S(  6, -6), S( 18, -9), S( 35,-10), S( 22,-18), S(  2,-18), S(-12,-17) },
   { S( 17, 17), S( -3,  0), S( -8,  0), S(  5, -3), S( 14,-13), S( -2,  2), S( -6, 12), S(  1,  6) },
   { S(-12, 28), S(-23, 26), S(  1,  8), S( 28, 29), S( -7, 23), S(-18,  6), S(-17,  6), S(-20, 10) },
   { S( -6,  4), S(  9, -2), S(  3, 10), S(-17, 22), S(  3, 21), S(-14, 22), S( 13, 10), S(-15,  1) }
  };
