...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11,-3), S( -1,  3), S(  5, 9), S(15, 0) },
   { S(-17,-3), S( -5,  4), S( 22, 3), S(23, 2) },
   { S(-12,12), S( -4, -4), S( 20,-8), S(24, 2) },
   { S( -2,14), S( -2,  7), S( -1, 3), S( 8, 2) },
   { S(-14,20), S(-14,  6), S(  0, 1), S( 9,18) },
   { S( -3,-2), S( 24,-13), S( -8, 6), S( 2,24) }
  },
  { // Knight
