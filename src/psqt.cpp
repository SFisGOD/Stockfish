...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(  0,-11), S( -3, -4), S( 13, -1), S( 19, -4) },
   { S(-16, -8), S(-12, -6), S( 20, -3), S( 21,  0) },
   { S(-11,  3), S(-17,  6), S( 11,-10), S( 21,  1) },
   { S(  4, 13), S(  6,  7), S( -8,  3), S(  3, -5) },
   { S( -5, 25), S(-19, 20), S(  7, 16), S(  8, 12) },
   { S(-10,  6), S(  9, -5), S( -7, 16), S(-12, 27) }
  },
  { // Knight
