...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   { S(-165,-105), S(-96,-78), S(-80,-46), S(-76,-16) },
   { S( -81, -70), S(-41,-55), S(-23,-16), S( -9,  7) },
   { S( -67, -44), S(-21,-36), S(  2, -6), S( 14, 27) },
   { S( -27, -38), S( 11,-19), S( 42, 10), S( 47, 36) },
   { S( -28, -43), S( 14,-22), S( 40,  4), S( 51, 37) },
   { S( -11, -52), S( 32,-38), S( 60,-12), S( 60, 23) },
   { S( -65, -64), S(-20,-47), S(  6,-31), S( 26, 15) },
   { S(-198,-103), S(-74,-89), S(-48,-52), S(-31,-15) }
  },
  { // Bishop
