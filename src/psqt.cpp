...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(270, -2), S(325, 43), S(274, 80), S(190, 92) },
   { S(277, 62), S(306, 98), S(245,138), S(182,131) },
   { S(200, 85), S(253,136), S(173,165), S(120,172) },
   { S(170,102), S(192,149), S(135,168), S(108,169) },
   { S(148, 97), S(174,167), S(113,198), S( 68,190) },
   { S(121, 89), S(159,162), S( 84,172), S( 33,190) },
   { S( 88, 40), S(123, 94), S( 64,130), S( 28,141) },
   { S( 63,  8), S( 87, 62), S( 54, 77), S(  0, 70) }
  }
};
