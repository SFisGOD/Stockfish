...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { },
  { // Knight
   { S(-167,-100), S(-94,-70), S(-78,-48), S(-80,-17) },
   { S( -81, -67), S(-43,-56), S(-21,-16), S(-14,  6) },
   { S( -61, -39), S(-19,-35), S(  6, -6), S( 17, 26) },
   { S( -29, -37), S(  3,  2), S( 42, 13), S( 48, 33) },
   { S( -30, -42), S( 13,-20), S( 44,  2), S( 50, 36) },
   { S(  -9, -55), S( 26,-40), S( 62,-18), S( 56, 20) },
   { S( -70, -69), S(-25,-49), S(  6,-42), S( 37, 15) },
   { S(-199,-102), S(-82,-88), S(-54,-51), S(-29,-17) }
  },
  { // Bishop
