...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -7, -8), S(  4,  0), S( 10,  3), S( 17,  6) },
   { S(-20, -4), S( -6, -2), S( 24,  3), S( 23, -5) },
   { S(-12,  1), S(-11,  0), S( 16,-10), S( 26, -2) },
   { S( -1, 13), S( -6,  8), S( -5,  1), S(  9,-10) },
   { S(-11, 20), S(-15,  8), S(  2,  6), S(  1, 17) },
   { S( -6,  5), S( 16, -9), S( -8, 10), S( -6, 21) }
  },
  { // Knight
