...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(-11,-1), S(  3,  1), S( 5, 7), S(14, 2) },
   { S(-18,-4), S( -2,  1), S(21, 3), S(28,-2) },
   { S(-12, 6), S( -7, -4), S(23,-6), S(26, 3) },
   { S( -4,12), S( -3, 10), S(-3,-1), S( 9,-2) },
   { S(-10,14), S(-14,  4), S(-1, 1), S( 5,15) },
   { S( -1, 1), S( 22,-12), S(-8, 5), S(-1,21) }
  },
  { // Knight
