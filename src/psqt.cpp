...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-24, 0), S(-15, 1), S( -9, 3), S( 4, 4) },
   { S(-20,-2), S( -7,-2), S( -2,-2), S( 1,-1) },
   { S(-20, 2), S(-10,-2), S( -2, 1), S( 1, 1) },
   { S(-21, 0), S( -7, 1), S( -2,-1), S( 0, 1) },
   { S(-21,-2), S( -9, 2), S( -1,-2), S( 2,-2) },
   { S(-22, 1), S( -8, 1), S(  1,-1), S( 3, 1) },
   { S(-11,-1), S(  5, 2), S(  9, 4), S(12,-1) },
   { S(-24, 2), S(-16, 1), S(-11, 2), S(-3, 1) }
  },
  { // Queen
