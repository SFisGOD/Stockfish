...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-28, -8), S(-19,-14), S(-10,-10), S(-3, -9) },
   { S(-21,-18), S(-20, -8), S( -7,  0), S( 6, -1) },
   { S(-28,  2), S(-17, -5), S(  4,  4), S( 9,-15) },
   { S(-14, -3), S( -2, -2), S( -9, -9), S(-7,  9) },
   { S(-34, -1), S( -9, 11), S( -2, 11), S( 7,  1) },
   { S(-18,  8), S( -2, 10), S(  5, -8), S( 5, 14) },
   { S( -1,  3), S( 11,  4), S( 14, 22), S(21, -5) },
   { S( -7, 20), S(-20, -2), S(  2, 24), S( 3, 17) }
  },
  { // Queen
