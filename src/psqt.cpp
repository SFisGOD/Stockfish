...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-56,-55), S( -5,-31), S( -8,-37), S(-21,-14) },
   { S(-14,-36), S(  8,-13), S( 20,-18), S(  4,  1) },
   { S( -6,-16), S( 20, -2), S( -5, -1), S( 17, 10) },
   { S( -6,-18), S( 12, -7), S( 25,  0), S( 39, 17) },
   { S(-14,-15), S( 28,  1), S( 21,-15), S( 32, 15) },
   { S(-16,-31), S(  6,  7), S(  2,  4), S( 12,  3) },
   { S(-16,-31), S(-13,-20), S(  4,  1), S(  1, -1) },
   { S(-48,-44), S(  2,-43), S(-15,-37), S(-23,-26) }
  },
  { // Rook
