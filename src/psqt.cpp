...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -4,-13), S(  4,  4), S( 13,  7), S( 16, 17) },
   { S(-27, -1), S(  0,  0), S( 29,  3), S( 25,-11) },
   { S(-14, -2), S( -5,  0), S( 19,-11), S( 32, -6) },
   { S( -5, 13), S(-19,  9), S( -2, -1), S(  8,-15) },
   { S(-16, 15), S(-10, -4), S( -2,  3), S( -7, 21) },
   { S( -8,  4), S( 16, -7), S( -8, 11), S( -7, 15) }
  },
  { // Knight
