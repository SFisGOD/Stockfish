...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -7,-3), S(  8,  1), S(  9,10), S(17, 5) },
   { S(-15,-1), S( -2,  2), S( 23, 6), S(23, 2) },
   { S(-14, 7), S( -4, -2), S( 18,-8), S(25,-2) },
   { S( -5,18), S( -4,  7), S( -2,-5), S( 7,-4) },
   { S(-11,14), S( -8,  9), S(  1, 3), S( 7,15) },
   { S(  2, 0), S( 22,-14), S( -5,10), S( 6,20) }
  },
  { // Knight
