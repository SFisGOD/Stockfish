...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-22, -6), S(-18,-17), S( -2,-10), S(  2,-10) },
   { S(-21,-30), S(-34, -5), S( -4,  1), S(  5,  0) },
   { S(-33, -7), S(-29,  0), S( 13, 17), S( 21,-32) },
   { S(-15,  3), S(  3, -7), S(-19, -8), S( -8, 13) },
   { S(-47,  7), S(  3, 17), S(  3, 20), S( 16, 14) },
   { S(-11, 11), S( -1, 28), S(  2, -9), S(-10, 21) },
   { S(  0,  0), S(  8,  3), S( 10, 25), S( 27, -4) },
   { S( 12, 24), S(-22, -5), S(  8, 33), S(-10, 26) }
  },
  { // Queen
