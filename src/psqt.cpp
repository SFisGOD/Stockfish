...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S(  2,-1), S( 10,  7), S( 13, 17), S(18, 11) },
   { S(-12, 2), S(  0,  4), S( 23,  6), S(25,  8) },
   { S(-13, 5), S(  3,  3), S( 13, -6), S(27,-10) },
   { S( -5,27), S( -9,  1), S( -4,-14), S(-3,  3) },
   { S( -9, 9), S( -1, 14), S(  7,  8), S(14, 12) },
   { S(  9,-3), S( 26,-19), S(  5, 19), S(23, 11) }
  },
  { // Knight
