...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { },
  { // Knight
   { S(-180, -87), S(-89,-57), S(-69,-53), S(-68,-24) },
   { S( -75, -64), S(-42,-52), S(-30,-20), S(-20,  9) },
   { S( -59, -42), S(-15,-21), S(  8,-10), S(  6, 31) },
   { S( -40, -33), S( 10, -4), S( 39, 13), S( 51, 22) },
   { S( -38, -48), S( 13,-12), S( 46, 13), S( 50, 41) },
   { S(  -8, -52), S( 16,-50), S( 54,-14), S( 52, 16) },
   { S( -66, -74), S(-33,-54), S(  2,-65), S( 37,  8) },
   { S(-202,-101), S(-85,-86), S(-59,-58), S(-20,-18) }
  },
  { // Bishop
