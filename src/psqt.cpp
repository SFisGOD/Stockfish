...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  2, -3), S(  2, -3), S( 11,  5), S( 16,  6), S( 18, 14), S( 22,  8), S(  9, -2), S( -3,-20) },
   { S( -5,-10), S(-17, -7), S( 15, -8), S( 12, -1), S( 34, -1), S( 25,  2), S(  4, -6), S(-21, -4) },
   { S( -5,  3), S(-24, -3), S(  6, -7), S( 19, -7), S( 37,-11), S( 20,-15), S(  3,-14), S(-12,-13) },
   { S( 15, 13), S( -2,  2), S(-10,  1), S(  3, -7), S( 13,-13), S( -2, -2), S( -9, 12), S(  3,  7) },
   { S( -9, 28), S(-17, 23), S( -3, 15), S( 25, 29), S( -7, 26), S(-11,  6), S(-16,  7), S(-19, 11) },
   { S( -6,  2), S(  8, -6), S(  0, 11), S(-15, 22), S(  4, 23), S(-15, 21), S( 12,  7), S(-12,  4) }
  };
