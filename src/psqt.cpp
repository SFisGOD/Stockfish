...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  2, -3), S(  4, -3), S( 15,  4), S( 15, 10), S( 19, 18), S( 22, 11), S(  8, -3), S( -7,-20) },
   { S( -3,-13), S(-14, -5), S( 11, -6), S(  8, -1), S( 31, -3), S( 25,  6), S(  2, -8), S(-22, -3) },
   { S(  2,  4), S(-26, -4), S(  4, -9), S( 15, -3), S( 38, -9), S( 16,-15), S(  2,-13), S(-12,-20) },
   { S( 18, 11), S( -2,  9), S(-15, -3), S(  3, -8), S( 12,-13), S(  0,  0), S( -8,  8), S( -4, 11) },
   { S( -9, 30), S(-17, 20), S( -6, 12), S( 29, 29), S( -6, 24), S(-11,  9), S(-15,  3), S(-15,  9) },
   { S( -3,  1), S(  4, -8), S(  2,  6), S(-15, 26), S(  6, 21), S(-13, 21), S( 14, 10), S(-14,  3) }
  };
