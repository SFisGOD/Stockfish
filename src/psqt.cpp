...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  1,-11), S(  0, -7), S(  9, 10), S( 17, -3), S( 15, 14), S( 19, 10), S( 10, -5), S(  1,-19) },
   { S( -5,-11), S(-18,-10), S( 10,-12), S( 13,  5), S( 29,  2), S( 23,  2), S(  6, -7), S(-23, -5) },
   { S( -4,  6), S(-16,  0), S(  7, -7), S( 21, -5), S( 38,-13), S( 20,-11), S(  7, -4), S(-13,-10) },
   { S( 16,  8), S(  1,  6), S(-11,  5), S( -1,-11), S( 10,-11), S(  1, -7), S(-15, 10), S(  6, 10) },
   { S( -5, 26), S(-17, 18), S( -8, 19), S( 20, 26), S( -5, 28), S( -2,  9), S(-21,  7), S(-18, 13) },
   { S( -8,  4), S(  4, -6), S( -3, 14), S(-14, 21), S(  3, 25), S(-13, 15), S( 12,  5), S( -9,  9) }
  };
