...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  0,-11), S( -2, -9), S(  8, 10), S( 16, -4), S( 13, 14), S( 18, 12), S( 12,  6), S(-10,-17) },
   { S( -2,-12), S(-20, -9), S(  9,-12), S( 12,  5), S( 26,  1), S( 25,  0), S(  5, -8), S(-24, -4) },
   { S( -1,  7), S(-11,  1), S(  8, -6), S( 21, -5), S( 36,-12), S( 22,-11), S(  9,  2), S(-15, -9) },
   { S( 18,  7), S(  2,  7), S(-10,  6), S( -4,-12), S(  9, -9), S(  3, -8), S(-14,  8), S(  7,  9) },
   { S( -4, 24), S(-21, 15), S( -9, 18), S( 18, 25), S( -2, 26), S(  1, 11), S(-26,  6), S(-16, 13) },
   { S( -8,  6), S(  3, -2), S( -4, 16), S(-14, 21), S(  0, 24), S(-10, 12), S( 15,  7), S( -9, 10) }
  };
