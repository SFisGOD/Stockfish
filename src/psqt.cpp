...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  4, -4), S(  1, -4), S(  9,  4), S( 17,  6), S( 18, 14), S( 21,  8), S(  7, -3), S( -5,-20) },
   { S( -6,-11), S(-16, -9), S( 14, -7), S( 12, -1), S( 34, -1), S( 26,  3), S(  4, -8), S(-22, -5) },
   { S( -3,  3), S(-24, -2), S(  6, -7), S( 18, -6), S( 37,-10), S( 18,-15), S(  2,-14), S(-12,-14) },
   { S( 15, 13), S( -1,  3), S(-13, -1), S(  4, -8), S( 13,-14), S( -3, -1), S(-10, 14), S(  1,  8) },
   { S( -9, 28), S(-18, 24), S( -3, 15), S( 26, 29), S( -8, 26), S(-11,  8), S(-17,  6), S(-18, 12) },
   { S( -6,  2), S(  9, -6), S(  0, 11), S(-16, 22), S(  5, 22), S(-14, 21), S( 12,  7), S(-12,  3) }
  };
