...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   { S(  0,-71), S(-4,-56), S(-3,-42), S( 4,-29) },
   { S( -4,-56), S( 6,-30), S( 9,-21), S( 8, -5) },
   { S( -2,-39), S( 6,-17), S(13, -8), S( 0,  0) },
   { S( -1,-29), S( 8, -5), S(10, 13), S(10, 24) },
   { S( -3,-35), S( 9, -5), S( 8, 10), S( 7, 21) },
   { S( -2,-38), S( 6,-23), S( 8,-10), S(10, -3) },
   { S(-13,-55), S( 4,-30), S(10,-24), S( 6,-12) },
   { S( -6,-74), S(-2,-55), S(-1,-43), S( 0,-30) }
  },
  { // King
