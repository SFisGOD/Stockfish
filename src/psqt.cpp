...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // King
   { S(272,  9), S(328, 39), S(276, 72), S(193, 89) },
   { S(277, 52), S(302,100), S(248,137), S(177,131) },
   { S(206, 88), S(252,143), S(164,163), S(124,170) },
   { S(170,110), S(195,158), S(137,181), S( 96,173) },
   { S(142,100), S(176,173), S(113,195), S( 67,195) },
   { S(114, 91), S(152,170), S( 81,178), S( 29,192) },
   { S( 91, 48), S(118, 98), S( 65,128), S( 31,140) },
   { S( 67, 13), S( 88, 57), S( 47, 76), S( -6, 72) }
  }
};
