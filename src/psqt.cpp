...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   { },
   { S( -4,-12), S(  4, -3), S( 17,  6), S( 17, 12) },
   { S(-13, -9), S( -4, -6), S( 17, -1), S( 20, -2) },
   { S( -5, -7), S(-10, -9), S( 11,-12), S( 29, -8) },
   { S(  6, 12), S( -6,  6), S( -6, -4), S(  7,-12) },
   { S(-11, 19), S(-16, 12), S( -9, 10), S( 10, 28) },
   { S( -9,  2), S(  9,  0), S( -6, 12), S( -4, 24) }
  },
  { // Knight
