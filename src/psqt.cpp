...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   ...
   { S( -9,  4), S(-18,-5), S(  8,-4), S( 33,-5), S( 33, -6), S( 25,-13), S( -4,-3), S(-16, -7) },
   { S(  6, 18), S( -3, 2), S(-10, 2), S(  1,-9), S( 22, -7), S(  6, -8), S(-12,11), S(  1,  9) },
   { S( -6, 25), S( -8,17), S(  5,19), S( 11,29), S(-14, 29), S(  0,  8), S(-12, 4), S( -4, 22) },
