...
constexpr Score PBonus[RANK_NB][FILE_NB] =
  { // Pawn (asymmetric distribution)
   { },
   { S(  1, -6), S( -2, -5), S( 16,  7), S( 13,  7), S( 20, 16), S( 20,  5), S(  7, -4), S( -6,-21) },
   { S( -2,-13), S(-15, -6), S( 13, -9), S( 11,  1), S( 35, -1), S( 25,  5), S(  8, -6), S(-21, -4) },
   { S( -1,  4), S(-21, -4), S(  5, -8), S( 19, -4), S( 40, -8), S( 15,-17), S(  1,-12), S( -9,-14) },
   { S( 10, 11), S( -4,  4), S(-15, -1), S(  3,-10), S( 10,-14), S( -2,  0), S( -7,  9), S( -2,  5) },
   { S( -6, 24), S(-13, 23), S( -8,  9), S( 23, 28), S( -6, 26), S(-11, 10), S(-18,  7), S(-14, 14) },
   { S( -7,  1), S(  6,-13), S( -1, 10), S(-16, 23), S(  5, 22), S(-10, 20), S( 12,  8), S(-11,  2) }
  };
