...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score RookOnFile[] = { S(19, 1), S(40, 20) };

  // ThreatByMinor/ByRook[attacked PieceType] contains bonuses according to
  // which piece type attacks which one. Attacks on lesser pieces which are
  // pawn-defended are not considered.
  constexpr Score ThreatByMinor[PIECE_TYPE_NB] = {
    S(0, 0), S(0, 30), S(36, 41), S(52, 51), S(62, 107), S(70, 125)
  };

  constexpr Score ThreatByRook[PIECE_TYPE_NB] = {
    S(0, 0), S(0, 16), S(31, 76), S(36, 57), S(0, 42), S(47, 36)
  };
  ...
  constexpr Score PassedFile[FILE_NB] = {
    S( -6,  6), S( 2,  8), S(-5, -5), S(-35, -7),
    S(-25,-14), S(-9, -9), S(-3,  8), S(-13,  2)
  };
  ...
  constexpr Score LongDiagonalBishop = S( 44,  3);
  constexpr Score MinorBehindPawn    = S( 14,  2);
  constexpr Score PawnlessFlank      = S( 22, 97);
  constexpr Score RestrictedPiece    = S(  7,  7);
  constexpr Score RookOnPawn         = S( 10, 32);
  constexpr Score SliderOnQueen      = S( 59, 18);
  constexpr Score ThreatByKing       = S( 21, 92);
