...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      bool  classical =   largePsq
                       || ( (pos.this_thread()->nodes & 0x8) && psq > 467)                              // 1 in 2 chance
                       || (!(pos.this_thread()->nodes & 0x9) && !(psq > 467) && psq > 259)              // 1 in 4 chance
                       || (!(pos.this_thread()->nodes & 0xB) && !(psq > 259) && psq > PawnValueMg / 4); // 1 in 8 chance
