...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      bool  classical =   largePsq 
                       ...
                       || (pos.side_to_move() == BLACK && eg_value(pos.psq_score()) >  PawnValueMg && !(pos.this_thread()->nodes & 0xD))
                       || (pos.side_to_move() == WHITE && eg_value(pos.psq_score()) < -PawnValueMg && !(pos.this_thread()->nodes & 0xE));
