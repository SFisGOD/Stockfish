...
#define S(mg, eg) make_score(mg, eg)
  ...
  Score PassedCount        = S(  9,  9);
  Score PawnCount          = S( 11, 11);
  Score Outflanking        = S(  9,  9);
  Score PawnsOnBothFlanks  = S( 21, 21);
  Score NoPieces           = S( 51, 51);
  Score AlmostUnwinnable   = S( 43, 43);
  Score Offset             = S( 45, 95);
  
  TUNE(SetRange(   0,  60), PassedCount       ); 
  TUNE(SetRange(   0,  40), PawnCount         );
  TUNE(SetRange(   0,  40), Outflanking       );
  TUNE(SetRange(-150, 150), PawnsOnBothFlanks );
  TUNE(SetRange(-150, 150), NoPieces          );
  TUNE(SetRange(-150, 150), AlmostUnwinnable  );
  TUNE(SetRange(-150, 150), Offset            );
