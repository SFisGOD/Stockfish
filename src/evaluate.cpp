        ...
        if (Pt == BISHOP || Pt == KNIGHT)
        {
                ...
                && !(b & pos.pieces(Them) & ~pos.pieces(PAWN)))
            {
                if (Us == WHITE)
                {
                    if (s & QueenSide )
                    {
                        if ((SQ_A8 & pos.pieces(Them)) && !more_than_two((pos.pieces(Them) & ~pos.pieces(PAWN)) & QueenSide))
                            score += BadOutpost;
                        else if((SQ_A8 & ~pos.pieces(Them)) && !more_than_one((pos.pieces(Them) & ~pos.pieces(PAWN)) & QueenSide))
							score += BadOutpost;
                        else
                            score += Outpost[0];
                ...
                else
                {
                    if (s & QueenSide )
                    {
                        if ((SQ_A1 & pos.pieces(Them)) && !more_than_two((pos.pieces(Them) & ~pos.pieces(PAWN)) & QueenSide))
                            score += BadOutpost;
                        else if((SQ_A1 & ~pos.pieces(Them)) && !more_than_one((pos.pieces(Them) & ~pos.pieces(PAWN)) & QueenSide))
							score += BadOutpost;
                        else
                            score += Outpost[0];
